...
public class PatientInsuranceController {
   ...
   @GetMapping("/patientDni/{dni}")
    public ResponseEntity<List<PatientInsuranceResponseDto>> findPatientInsuranceByPatientDni(@PathVariable Long dni){
    ...
    @PostMapping("/create")
    public ResponseEntity<PatientInsuranceResponseDto> createPatientInsurance(@RequestBody @Valid PatientInsuranceCreateDto dto){
