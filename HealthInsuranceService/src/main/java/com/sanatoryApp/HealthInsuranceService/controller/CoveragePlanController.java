...
public class CoveragePlanController {
    ...
    @PostMapping("/create")
    public ResponseEntity <CoveragePlanResponseDto> createCoveragePlan(@Valid @RequestBody CoveragePlanCreateDto dto){
        return ResponseEntity.ok(coveragePlanService.createCoveragePlan(dto));
    }

    @PatchMapping("/update/{id}")
    public  ResponseEntity<CoveragePlanResponseDto> updateCoveragePlanById(@PathVariable Long id,
    ...
    public ResponseEntity <List<CoveragePlanResponseDto>>findByHealthInsuranceId(@PathVariable Long healthInsuranceId){
    ...
    public ResponseEntity <List<CoveragePlanResponseDto>> findByHealthInsuranceIdAndIsActiveTrue(Long healthInsuranceId){
